...
def create_View(model, schema, database=None, need_user=False, **kwargs):
    """创建View的工厂方法"""
    ...
    class View:
        ...
        def __init__(self,model,database,schema, **kwargs):
            """
            初始化基于类的视图,
        ...
        async def create(self, instance: schema = Body(..., ),
                         current_user: User = Depends(create_current_active_user(need_user))):
            print(current_user)
    ...
    return View(model,database,schema)
